...
## 👨‍💻 Sobre Mim
Olá! Sou o Cezar de Souza Carvalho, um profissional em transição de carreira com uma trajetória sólida de 16 anos no setor da aviação, onde desenvolvi competências críticas em resiliência, comunicação e foco no cliente.

Atualmente, concluirei Gestão em Tecnologia da Informação. Busco direcionar a minha experiência para as áreas de Análise de Dados e Business Intelligence (BI). Minha bagagem profissional anterior foi em apoio operacional, prevenção de fraudes e atendimento ao cliente (SAC) proporciona-me uma visão analítica apurada sobre processos de negócio e a experiência do utilizador.

## 🎯 Objetivos e Interesses
📊 Data & BI: Transformar dados brutos em informações estratégicas para a tomada de decisão.

🤝 Customer Success: Aplicar a minha experiência em atendimento para garantir a melhor jornada ao utilizador final.

💻 Gestão de TI: Alinhamento de soluções tecnológicas com as necessidades organizacionais.

## 🛠️ Competências em Desenvolvimento
Lógica de Programação: Experiência prática com algoritmos e programação estruturada.

Ferramentas: SQL, Excel Avançado e exploração de plataformas de BI.

Soft Skills: Gestão de crises, atendimento especializado e suporte operacional.
